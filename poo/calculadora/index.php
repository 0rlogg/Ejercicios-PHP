...
<fieldset id="ayuda">
    ...
    <div id=texhelp> Los operadores reales permitidos son <strong style="color: red"> +  -  *  /</strong></div>
    <div id=texhelp> Los operadores racionales permitidos son <strong style="color: red"> +  -  *  :</strong></div>
...
<fieldset>
    ...
    <form action="." method="post">
        ...
        <label for=""><input type="text" name="operacion" id=""></label>
        <input type="submit" name="enviar" value="Calcular">
        <?php
        if (isset($_POST['enviar'])) {
            if (!empty($operacionNum)) {
